      ...
      >
        <v-card class="py-2 custom-shadow" variant="text" rounded="xl">
          <v-card-item class="">
            <v-img
              :src="food.imageUrl"
              class="bg-grey-lighten-2 align-center custom-radius aspect-ratio"
              width="100%"
            >
          ...
          <v-card-title class="mx-4 text-h4 text-start text-wrap">{{
            food.name
          }}</v-card-title>
          <v-card-text class="mx-4 text-subtitle-1">{{
            food.description
          }}</v-card-text>
          ...
          <v-card-actions class="d-flex justify-between">
            ...
            <v-card-text
              class="mx-4 text-end text-h5 font-weight-medium text-primary"
              >Cijena: {{ food.price }} KM</v-card-text
            >
          </v-card-actions>
          <v-card-actions
            class="d-flex flex-column flex-sm-row justify-space-evenly"
          >
            <v-btn
              color="primary"
              variant="tonal"
            ...
            <v-btn
              v-if="!basketStore.basket.isFoodInBasket"
              color="primary"
              variant="flat"
            ...
            <v-btn
              ...
              color="primary"
              variant="outlined"
              prepend-icon="mdi-basket-remove-outline"
              min-width="48%"
              width="98%"
              class="custom-radius w-sm-auto"
              @click="basketStore.removeFoodFromBasket(food.id)"
              size="large"
            >
              Ukloni iz narudžbe
            </v-btn>
